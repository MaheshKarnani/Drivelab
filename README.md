...
*GFP labelled neurons send long-range axons <br>
from the <font color="blue">prefrontal cortex (blue) </font> <br>
to the <font color="pink">ateral hypothalamus (pink)</font>.*
